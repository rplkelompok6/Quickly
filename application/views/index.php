  ...
  <div class="main">
    ...
    <header>
      <div class="wrapper">
        ...
        <nav>
          <ul id="menu">
            <li id="menu_active"><a href="<?php echo base_url();?>index.php/auth/index">Home</a></li>
        
            <li><a href="<?php echo base_url();?>index.php/auth/berita">Berita</a></li>

            <li><a href="<?php echo site_url('auth/tampil_posko'); ?>">Posko Bencana</a></li>
      ...
      <div class="slider">
        <ul class="items">
          <li> <img src="<?php echo base_url();?>images/img1.jpg" alt="">
            <div class="banner">
    ...
    <article id="content">
      ...
      <div class="wrapper">
        <h3>Our Mission</h3>
        <p class="quot"> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incid- idunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exerci- tation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse.<img src="<?php echo base_url();?>images/quot2.png" alt=""> </p>
      </div>
      <div class="wrapper">
        <div class="box2">
          <div class="line1">
    ...
    <!-- footer -->
    <footer>
      <div class="wrapper"> <a href="index.html" id="footer_logo"><span> Quickly</span></a>
        <ul id="icons">
