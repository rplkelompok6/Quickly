  ...
  <div class="main">
    ...
    <header>
      ...
      <div class="wrapper">
       ...
       <center><a href="<?php echo base_url();?>index.php/cadmin/tambah_user">Tambah User</a>
                </div>
            ...
            <?php
            foreach($tampil_user->result() as $row)
            {
            ?>
            ...
            <tr align="center">
                ...
                <td><?php echo $row->password;?></td>
                  ...
                  <td><?php echo anchor("cadmin/tadit_user/$row->username","Edit");?></td>
                <td><?php echo anchor("cadmin/hapus_user/$row->username","Hapus");?></td>
