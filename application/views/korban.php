...
<div class="body1">
  <div class="main">
      ...
      <div class="wrapper">
        ...
        <nav>
          <ul id="menu">
            ...
            <li id="menu_active"><a href="<?php echo site_url('auth/tampil_korban'); ?>">Korban Bencana</a></li>
    ...
    <article id="content">
     ...
     <?php
            foreach($tampil_korban->result() as $row)
            {
            ?> 
        <tr>
        <td><?php echo $row->ktp;?></td>
         <td><?php echo $row->foto_korban;?></td>
        <td><?php echo $row->nama_korban;?></td>
        <td><?php echo $row->alamat_korban;?></td>
         <td><?php echo $row->ttl_korban;?></td>
         <td><?php echo $row->jk_korban;?></td>
           <td><?php echo $row->kondisi_korban;?></td>
         </tr>
         <?php } ?>
         </table>
