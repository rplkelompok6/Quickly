      ...
      <div class="wrapper">
        ...
        <nav>
          <ul id="menu">
            ...
            <li><a href="<?php echo site_url('crelawan/tampil_posko'); ?>">Data posko</a></li>
            <li><a href="news.html">data korban bencana korban bencana</a></li>
